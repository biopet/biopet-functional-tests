...
class MappingSingleR1NotExistTest extends Mapping with PipelineFail with TestReference with BwaMem {
...
class MappingPairedR1NotExistTest extends Mapping with PipelineFail with TestReference with BwaMem {
  override def r1 = Some(new File(Biopet.fixtureDir, "This_should_not_exist.R1.fq"))
...
class MappingPairedR2NotExistTest extends Mapping with PipelineFail with TestReference with BwaMem {
...
class MappingDryRunSingleR1NotExistTest extends Mapping with PipelineFail with TestReference with BwaMem {
  override def run = false
  override def r1 = Some(new File(Biopet.fixtureDir, "This_should_not_exist.R1.fq"))
  logMustNotHave("""FunctionEdge - Starting""".r)
...
class MappingDryRunPairedR1NotExistTest extends Mapping with PipelineFail with TestReference with BwaMem {
  override def run = false
  override def r1 = Some(new File(Biopet.fixtureDir, "This_should_not_exist.R1.fq"))
  override def r2 = Some(Biopet.fixtureFile("samples" + File.separator + "wgs1" + File.separator + "R2.fq.gz"))
...
class MappingDryRunPairedR2NotExistTest extends Mapping with PipelineFail with TestReference with BwaMem {
  override def run = false
  override def r1 = Some(Biopet.fixtureFile("samples" + File.separator + "wgs1" + File.separator + "R1.fq.gz"))
  override def r2 = Some(new File(Biopet.fixtureDir, "This_should_not_exist.R2.fq"))
...
class MappingDryRunNoOutputDirTest extends Mapping with PipelineFail with TestReference with BwaMem {
  override def outputDirArg = None
  override def run = false
  override def r1 = Some(Biopet.fixtureFile("samples" + File.separator + "wgs1" + File.separator + "R1.fq.gz"))
