 ...
 */
class ShivaNoSamplesTest extends Shiva with PipelineFail with BwaMem with TestReference {
...
class ShivaNoOutputDirTest extends Shiva with PipelineFail with BwaMem with TestReference {
  override def variantcallers = "haplotypecaller" :: Nil
...
class ShivaWrongMd5Test extends Shiva with PipelineFail with BwaMem with TestReference {
  override def variantcallers = "haplotypecaller" :: Nil
  override def configs = super.configs ::: Samples.wgs1Config :: Nil
